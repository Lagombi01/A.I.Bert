  ...
  return (
    <div>
      <div class="bubbles home-bubbles">
        <div class="bubble flex-container" onClick={() => navigate("/help")}>
        ...
        <div class="bubble flex-container" onClick={handleClick}>
          ...
          <p classname="nav-title">{isLoggedIn ? "Profile" : "Login"}</p>
        </div>
        ...
        <div class="bubble flex-container" onClick={() => navigate("/home")}>
          <i class="chatbotIcon">
            ...
            <img
              src={squirrel}
              class="miniMascot"
              style={{ opacity: globalVariables.mini ? 1 : 0 }}
              onLoad={genericMiniAppear}
              alt=""
            ></img>
          </i>
        ...
        <div class="bubble flex-container" onClick={() => navigate("/courses")}>
          <i class="fa colored-text">
        ...
        >
          ...
          <p classname="nav-title">Learning Journeys</p>
        </div>
      </div>
    </div>
  );
